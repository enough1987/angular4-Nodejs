...
module.exports = "<app-header>\n</app-header>\n\n\n<div class=\"main-container-in main-container-in-small pad__auth-form\">\n\n  <div *ngIf=\"authorizeCode\" >\n    <div>\n      <input type=\"email\" class=\"field field2\" \n      [(ngModel)]=\"paypalAccout\">\n    </div>\n    <div>\n      <button \n      (click)=\"paypalGet()\"> \n        PAYPAL \n      </button>\n    </div>\n  </div>\n\n\n  <div *ngIf=\"!authorizeCode\" >\n    <button (click)=\"paypalLogin()\"> first login paypal</button>\n  </div>\n\n\n  <div >\n    <button (click)=\"paypalLogin()\"> paypalLogin </button>\n  </div>\n\n\n\n\n</div>"
...
var MainComponent = (function () {
    function MainComponent(activatedRoute, httpService, authService) {
        var _this = this;
        this.activatedRoute = activatedRoute;
        this.httpService = httpService;
        this.authService = authService;
        this.paypalAccout = "tilgaaleksandr-facilitator-3@gmail.com";
        this.authorizeUrl = function () {
            _this.httpService.post("http://localhost:3000/api/paypal/authorizeUrl").subscribe(function (data) {
                console.log(" authorizeUrl : ", data);
                if (data.authorizeUrl) {
                    _this.authorizeCode = data.authorizeUrl;
                    console.log("%c " + _this.authorizeCode, 'background: #ee7; color: #36c');
                    //window.location.href = data.authorizeUrl ;
                }
            });
        };
        this.paypalToken = function (code) {
            _this.httpService.post("http://localhost:3000/api/paypal/tokeninfo", {
                code: code
            }).subscribe(function (data) {
        ...
        this.paypalUser = function (token) {
            _this.httpService.post("http://localhost:3000/api/paypal/user", {
                token: token
            }).subscribe(function (data) {
                console.log(" USER : ", data);
            });
        };
        this.paypalLogin = function () {
            window.location.href = _this.authorizeCode;
        };
        this.paypalGet = function () {
            _this.httpService.post("http://localhost:3000/api/paypal/payout", {
                amount: 1,
                currency: "USD",
                email: _this.paypalAccout,
                id_token: _this.paypal_id,
                description: "payout",
...
MainComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2_app_services_http_service__["a" /* HttpService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_app_services_http_service__["a" /* HttpService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3_app_services_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_app_services_auth_service__["a" /* AuthService */]) === "function" && _c || Object])
], MainComponent);
...
var PaypalService = (function () {
    function PaypalService(httpService) {
        var _this = this;
        this.httpService = httpService;
        this.origin = 'http://52.58.162.133:3000'; // "http://localhost:3000";
        this.getAuthorizeUrl = function () {
            return _this.httpService.post(_this.origin + "/api/paypal/authorizeUrl").map(function (data) {
                if (data.authorizeUrl) {
                    console.log(" authorizeUrl ", data);
        ...
        this.getUserInfo = function () {
            ...
            return _this.httpService.post(_this.origin + "/api/paypal/tokeninfoCreate", {
        ...
        this.payout = function () {
            ...
            return _this.httpService.post(_this.origin + "/api/paypal/payout", {
                amount: _this.amount,
                currency: "USD",
...
var SettingService = SettingService_1 = (function () {
    function SettingService() {
        return SettingService_1.instance ? SettingService_1.instance : this;
    }
